...
const myRollNo: number = Math.floor((Math.random())*100000);

let myBalance: number = 0; // create a balance variable and initialize with 0
...
let myTotalPayments : number = studentPayment.Payments;
let courseFees : number = fees[student.Course]
